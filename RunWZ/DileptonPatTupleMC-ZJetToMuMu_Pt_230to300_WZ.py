...
process.wzTreeMaker.outputFileName = '/uscms_data/d2/fantasia/38X/DileptonPatTupleMC-ZJetToMuMu_Pt_230to300_WZ.root'
process.source = cms.Source("PoolSource",
fileNames = cms.untracked.vstring(*(
'/store/user/fantasia/38X/DileptonPatTupleMC-V05-03-03-ZJetToMuMu_Pt_230to300/patTuple_1_1_E8X.root',
'/store/user/fantasia/38X/DileptonPatTupleMC-V05-03-03-ZJetToMuMu_Pt_230to300/patTuple_2_1_Uxj.root',
)))
