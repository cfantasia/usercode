...
process.wzTreeMaker.outputFileName = '/uscms_data/d2/fantasia/38X/TrileptonPatTupleMC-ZJetToMuMu_Pt_120to170_WZ.root'
process.source = cms.Source("PoolSource",
fileNames = cms.untracked.vstring(*(
'/store/user/fantasia/38X/TrileptonPatTupleMC-V05-03-03-ZJetToMuMu_Pt_120to170/patTuple_1_1_eTM.root',
'/store/user/fantasia/38X/TrileptonPatTupleMC-V05-03-03-ZJetToMuMu_Pt_120to170/patTuple_2_1_AO6.root',
)))
