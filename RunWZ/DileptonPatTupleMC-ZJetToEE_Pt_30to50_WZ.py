...
process.wzTreeMaker.outputFileName = '/uscms_data/d2/fantasia/38X/DileptonPatTupleMC-ZJetToEE_Pt_30to50_WZ.root'
process.source = cms.Source("PoolSource",
fileNames = cms.untracked.vstring(*(
'/store/user/fantasia/38X/DileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_30to50/patTuple_1_1_h9y.root',
'/store/user/fantasia/38X/DileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_30to50/patTuple_2_1_qr7.root',
)))
