...
process.wzTreeMaker.outputFileName = '/uscms_data/d2/fantasia/38X/DileptonPatTupleMC-ZJetToEE_Pt_20to30_WZ.root'
process.source = cms.Source("PoolSource",
fileNames = cms.untracked.vstring(*(
'/store/user/fantasia/38X/DileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_20to30/patTuple_1_1_sBd.root',
'/store/user/fantasia/38X/DileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_20to30/patTuple_2_1_7hD.root',
)))
