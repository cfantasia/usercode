...
process.wzTreeMaker.outputFileName = '/uscms_data/d2/fantasia/38X/TrileptonPatTupleMC-ZJetToEE_Pt_0to15_WZ.root'
process.source = cms.Source("PoolSource",
fileNames = cms.untracked.vstring(*(
'/store/user/fantasia/38X/TrileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_0to15/patTuple_1_1_dpz.root',
'/store/user/fantasia/38X/TrileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_0to15/patTuple_2_1_S5h.root',
)))
