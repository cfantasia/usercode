...
process.wzTreeMaker.outputFileName = '/uscms_data/d2/fantasia/38X/DileptonPatTupleMC-ZJetToEE_Pt_170to230_WZ.root'
process.source = cms.Source("PoolSource",
fileNames = cms.untracked.vstring(*(
'/store/user/fantasia/38X/DileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_170to230/patTuple_1_1_z83.root',
'/store/user/fantasia/38X/DileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_170to230/patTuple_2_1_iiB.root',
)))
