...
process.wzTreeMaker.outputFileName = '/uscms_data/d2/fantasia/38X/TrileptonPatTupleMC-ZJetToEE_Pt_50to80_WZ.root'
process.source = cms.Source("PoolSource",
fileNames = cms.untracked.vstring(*(
'/store/user/fantasia/38X/TrileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_50to80/patTuple_1_1_Hb1.root',
'/store/user/fantasia/38X/TrileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_50to80/patTuple_2_1_43n.root',
)))
