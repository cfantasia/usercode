...
process.wzTreeMaker.outputFileName = '/uscms_data/d2/fantasia/38X/DileptonPatTupleMC-ZJetToMuMu_Pt_300_WZ.root'
process.source = cms.Source("PoolSource",
fileNames = cms.untracked.vstring(*(
'/store/user/fantasia/38X/DileptonPatTupleMC-V05-03-03-ZJetToMuMu_Pt_300/patTuple_1_1_PrE.root',
'/store/user/fantasia/38X/DileptonPatTupleMC-V05-03-03-ZJetToMuMu_Pt_300/patTuple_2_1_Ok5.root',
)))
