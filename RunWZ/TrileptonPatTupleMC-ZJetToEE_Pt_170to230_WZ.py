...
process.wzTreeMaker.outputFileName = '/uscms_data/d2/fantasia/38X/TrileptonPatTupleMC-ZJetToEE_Pt_170to230_WZ.root'
process.source = cms.Source("PoolSource",
fileNames = cms.untracked.vstring(*(
'/store/user/fantasia/38X/TrileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_170to230/patTuple_1_1_Oqi.root',
'/store/user/fantasia/38X/TrileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_170to230/patTuple_2_1_whQ.root',
)))
