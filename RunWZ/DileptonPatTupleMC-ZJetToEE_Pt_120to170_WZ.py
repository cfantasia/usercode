...
process.wzTreeMaker.outputFileName = '/uscms_data/d2/fantasia/38X/DileptonPatTupleMC-ZJetToEE_Pt_120to170_WZ.root'
process.source = cms.Source("PoolSource",
fileNames = cms.untracked.vstring(*(
'/store/user/fantasia/38X/DileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_120to170/patTuple_1_1_tJW.root',
'/store/user/fantasia/38X/DileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_120to170/patTuple_2_1_dFl.root',
)))
