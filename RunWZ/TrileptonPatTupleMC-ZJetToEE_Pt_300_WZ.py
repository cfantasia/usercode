...
process.wzTreeMaker.outputFileName = '/uscms_data/d2/fantasia/38X/TrileptonPatTupleMC-ZJetToEE_Pt_300_WZ.root'
process.source = cms.Source("PoolSource",
fileNames = cms.untracked.vstring(*(
'/store/user/fantasia/38X/TrileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_300/patTuple_1_1_SJr.root',
'/store/user/fantasia/38X/TrileptonPatTupleMC-V05-03-03-ZJetToEE_Pt_300/patTuple_2_1_z90.root',
)))
