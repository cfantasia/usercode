#ifndef _ExecuteSMWZ_cxx_
#define _ExecuteSMWZ_cxx_
//------------------------------------------------
...
//--------------------------------------------------------------
  ...
  DeclareHistoSet("hElecPt", "Electron Pt",
                  "Pt", 30, 0, 300, Cut, hElecPt);

  DeclareHistoSet("hElecEt", "Electron Et",
                  "Et", 30, 0, 300, Cut, hElecEt);
...
#endif//#define _ExecuteSMWZ_cxx_

//  LocalWords:  InputFile
