...
Est_Zjets(){  
    ...
    allfiles.push_back("EGSep17ReReco_Dilepton");
    allfiles.push_back("MuSep17ReReco_Dilepton");
    allfiles.push_back("ElectronPromptReco_Dilepton");
    allfiles.push_back("MuPromptReco_Dilepton");
