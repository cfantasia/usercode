...
//-----------------------------------------------------------
  ...
  wz.SetCandEvtFile("ZJets_candEvts.txt");
  wz.SetLogFile("ZJets_event_counts.txt");
  wz.SetOutputFile("ZJets_analysis.root");
  ...
  wz.UseSample("Run2010Dilepton");
  wz.UseSample("Run2011");
  wz.UseSample("Run2011Dilepton");
}//ExecuteAnalysis
