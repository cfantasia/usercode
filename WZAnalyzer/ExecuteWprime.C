...
void ExecuteWprime(float lumi=1000, bool verbose=false);

//-----------------------------------------------------------
void ExecuteWprime(float lumi, bool verbose)
{
//-----------------------------------------------------------
  ...
  wz.SetCandEvtFile("Wprime_candEvts.txt");
  wz.SetLogFile("Wprime_event_counts.txt");
  wz.SetOutputFile("Wprime_analysis.root");
